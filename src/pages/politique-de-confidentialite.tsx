...
export const PolitiqueDeConfidentialitePage = () => {
  const jsonLd = JSON.stringify({
    ...
    "description": "Politique de confidentialité du site MAASGA Climatisation - Expert en climatisation à Ouagadougou, Burkina Faso.",
    "isPartOf": {
      "@type": "WebSite",
        ...
        <div class="space-y-8 reveal">
          ...
          <section class="glass-card rounded-2xl p-8">
            ...
            <p class="text-white mb-4">
              MAASGA Climatisation s'engage à protéger la vie privée de ses utilisateurs. Cette politique de confidentialité explique comment nous collectons, utilisons, divulguons et protégeons les informations personnelles lorsque vous utilisez notre site maasga-website.pages.dev.
            </p>
            <p class="text-white">
          ...
          <section class="glass-card rounded-2xl p-8">
            ...
            <ul class="list-disc list-inside text-white space-y-2">
              <li>Répondre à vos demandes de contact, de devis ou de rendez-vous.</li>
          ...
          <section class="glass-card rounded-2xl p-8">
            ...
            <p class="text-white mb-4">
              Nous ne vendons, n'échangeons ni ne louons vos informations personnelles à des tiers. Nous pouvons toutefois partager vos informations avec :
            </p>
            <ul class="list-disc list-inside text-white space-y-2">
              <li>Nos prestataires de services (hébergement, maintenance technique) qui ont besoin d'accéder à vos informations pour nous fournir leurs services.</li>
              <li>Les autorités légales lorsque la loi l'exige.</li>
            </ul>
            <p class="text-white mt-4">
              Nous exigeons de ces tiers qu'ils protègent vos informations conformément à cette politique de confidentialité et qu'ils ne les utilisent pas à d'autres fins.
            </p>
          </section>
          ...
          <section class="glass-card rounded-2xl p-8">
            ...
            <p class="text-white mb-4">
              Nous mettons en œuvre des mesures de sécurité appropriées pour protéger contre la perte, l'utilisation abusive, l'altération et la destruction des informations sous notre contrôle. Toutefois, aucune méthode de transmission sur Internet ou de stockage électronique n'est totalement sécurisée.
            </p>
            <p class="text-white">
              Nous ne pouvons donc garantir une sécurité absolue. Si vous avez des raisons de croire que votre interaction avec nous n'est plus sécurisée, veuillez nous en informer immédiatement en nous contactant à maasgabf@gmail.com.
            </p>
          </section>
          ...
          <section class="glass-card rounded-2xl p-8">
            ...
            <p class="text-white mb-4">
              Notre site utilise des cookies et des technologies similaires pour distinguer vous des autres utilisateurs de notre site. Cela nous aide à vous offrir une bonne expérience lorsque vous naviguez sur notre site et nous permet également d'améliorer notre site.
            </p>
            <p class="text-white">
          ...
          <section class="glass-card rounded-2xl p-8">
            ...
            <p class="text-white mb-4">
              Conformément à la loi burkinabé sur la protection des données personnelles, vous disposez des droits suivants concernant vos informations personnelles :
            </p>
            <ul class="list-disc list-inside text-white space-y-2">
              ...
              <li>Droit à la portabilité : vous pouvez demander la transmission de vos informations personnelles à un autre responsable de traitement.</li>
            </ul>
            <p class="text-white mt-4">
              Pour exercer ces droits, veuillez nous contacter à maasgabf@gmail.com.
            </p>
          </section>
          ...
          <section class="glass-card rounded-2xl p-8">
            ...
            <p class="text-white mb-4">
              Nous pouvons mettre à jour cette politique de confidentialité périodiquement. Nous vous informerons de toute modification en publiant la nouvelle politique sur cette page.
            </p>
            <p class="text-white">
